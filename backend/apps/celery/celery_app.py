...
DB access uses **sync** SQLAlchemy (SyncSessionLocal), not AsyncSessionLocal.
Prefork workers + asyncio.run() + a process-global async engine/asyncpg pool
causes "different loop" / "another operation is in progress" errors.
"""
...
from common.database import SyncSessionLocal  # noqa: E402
